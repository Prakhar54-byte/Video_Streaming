    ...
    const fetchLikedContent = async () => {
      try {
        const [videosRes, commentsRes, tweetsRes] = await Promise.all([
          fetch('http://localhost:8000/api/v1/likes/videos', { credentials: 'include' }),
          fetch('http://localhost:8000/api/v1/likes/comments', { credentials: 'include' }),
          fetch('http://localhost:8000/api/v1/likes/tweets', { credentials: 'include' })
        ])
