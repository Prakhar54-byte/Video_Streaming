      ...
      <div className="flex items-start">
        ...
        <div className="flex-grow">
          <a href={`/videos/${video._id}`} className="block">
            <h3 className="text-white font-semibold text-base leading-tight group-hover:text-gray-300">
              {video.title}
            </h3>
          </a>
          <a
          ...
          <p className="text-gray-400 text-sm">
            {formatViews(video.views)} &bull; {timeSince(video.createdAt)}
          </p>
        </div>
      </div>
    </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
            {Array.from({ length: 12 }).map((_, i) => (
              <div key={i} className="w-full animate-pulse">
                <div className="w-full h-40 bg-gray-700 rounded-lg mb-2" />
                <div className="flex items-start">
                  <div className="w-9 h-9 rounded-full bg-gray-700 mr-3" />
