      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-card border border-border p-10 rounded-xl shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-base font-semibold mb-3">
                Cover Image <span className="text-muted-foreground text-sm">(Optional)</span>
              </label>
              <div className="relative">
                <ImageIcon className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground pointer-events-none" />
                <input
          ...
          <div className="mt-8 text-center">
            <p className="text-base text-muted-foreground">
              ...
              <Link href="/auth/login" className="text-lg font-semibold bg-gradient-to-r from-orange-500 via-red-500 to-yellow-500 text-transparent bg-clip-text hover:underline">
                Sign In
              </Link>
            </p>
          </div>
