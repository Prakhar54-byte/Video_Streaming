...
export function AudienceAnalytics() {
  ...
  const geographicData = [
    { country: "United States", code: "US", percentage: 35.2, views: "1,002,847", subscribers: "16,841" },
    { country: "United Kingdom", code: "UK", percentage: 18.7, views: "532,456", subscribers: "8,945" },
    { country: "Canada", code: "CA", percentage: 12.3, views: "350,234", subscribers: "5,887" },
    { country: "Australia", code: "AU", percentage: 8.9, views: "253,421", subscribers: "4,256" },
    { country: "Germany", code: "DE", percentage: 7.1, views: "202,134", subscribers: "3,421" },
    { country: "France", code: "FR", percentage: 5.8, views: "165,089", subscribers: "2,789" },
    { country: "Netherlands", code: "NL", percentage: 4.2, views: "119,567", subscribers: "2,012" },
    { country: "Sweden", code: "SE", percentage: 3.1, views: "88,234", subscribers: "1,487" },
    { country: "Others", code: "XX", percentage: 4.7, views: "133,789", subscribers: "2,194" },
  ]
  ...
  const deviceData = [
    { device: "Mobile", percentage: 68.4, icon: <Smartphone className="w-5 h-5" />, color: "bg-blue-500" },
    { device: "Desktop", percentage: 24.7, icon: <Monitor className="w-5 h-5" />, color: "bg-green-500" },
    { device: "Tablet", percentage: 6.9, icon: <Tablet className="w-5 h-5" />, color: "bg-purple-500" },
  ]
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Audience Analytics</h1>
            <p className="text-gray-600 mt-1">Understand your viewers and their behavior patterns</p>
          </div>
        </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="text-center p-6 bg-blue-50 rounded-lg">
                        <div className="text-3xl font-bold text-blue-600">62.4%</div>
                      ...
                      <div className="text-center p-6 bg-pink-50 rounded-lg">
                        <div className="text-3xl font-bold text-pink-600">37.6%</div>
                    ...
                    <div className="space-y-3">
                      <h4 className="font-medium text-gray-900">Gender by Age Group</h4>
                      {["18-24", "25-34", "35-44", "45+"].map((age, index) => (
                        <div key={index} className="flex items-center justify-between">
                          <span className="text-sm text-gray-600">{age}</span>
                          <div className="flex items-center space-x-2">
                            <div className="w-16 h-2 bg-gray-200 rounded-full overflow-hidden">
                              <div className="h-full bg-blue-500" style={{ width: `${65 - index * 5}%` }}></div>
                            </div>
                            <span className="text-xs text-gray-500 w-8">{65 - index * 5}%</span>
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { interest: "Technology", percentage: 89.2, color: "bg-blue-500" },
                    { interest: "Programming", percentage: 76.8, color: "bg-green-500" },
                    { interest: "Web Development", percentage: 68.4, color: "bg-purple-500" },
                    { interest: "Software Engineering", percentage: 54.7, color: "bg-yellow-500" },
                    { interest: "AI & Machine Learning", percentage: 43.2, color: "bg-red-500" },
                    { interest: "Mobile Development", percentage: 38.9, color: "bg-indigo-500" },
                    { interest: "DevOps", percentage: 29.6, color: "bg-pink-500" },
                    { interest: "Cybersecurity", percentage: 21.3, color: "bg-gray-500" },
                  ].map((item, index) => (
                    <div key={index} className="p-4 bg-white border rounded-lg hover:shadow-md transition-shadow">
                      ...
                      <p className="text-sm font-medium text-gray-900">{item.interest}</p>
                    ...
                    <div className="space-y-4">
                      {geographicData.map((country, index) => (
                        ...
                        >
                          ...
                          <Progress value={country.percentage} className="h-2 mb-2" />
                      ...
                      {[
                        ...
                        <div key={index} className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            ...
                            <Progress value={city.percentage} className="w-16 h-1 mt-1" />
                          </div>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        <div key={index} className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            <Progress value={lang.percentage} className="w-16 h-2" />
                            <span className="text-sm font-bold w-10">{lang.percentage}%</span>
                          </div>
                        </div>
                      ))}
                    </div>
          ...
          <TabsContent value="devices" className="space-y-6">
                  ...
                  <div className="space-y-6">
                    {deviceData.map((device, index) => (
                      <div key={index} className="space-y-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-3">
                            <div className={`p-2 ${device.color} text-white rounded-lg`}>{device.icon}</div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex items-center space-x-3">
                          <Progress value={os.percentage} className="w-20 h-2" />
                          <span className="font-bold w-12">{os.percentage}%</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  {[
                    { browser: "Chrome", percentage: 68.4, color: "bg-yellow-500" },
                    { browser: "Safari", percentage: 18.7, color: "bg-blue-500" },
                    { browser: "Firefox", percentage: 7.2, color: "bg-orange-500" },
                    { browser: "Edge", percentage: 4.1, color: "bg-blue-600" },
                    { browser: "Opera", percentage: 1.2, color: "bg-red-500" },
                    { browser: "Others", percentage: 0.4, color: "bg-gray-500" },
                  ].map((browser, index) => (
                    <div key={index} className="text-center p-4 bg-white border rounded-lg">
                      ...
                      <p className="text-xl font-bold text-gray-900 mt-1">{browser.percentage}%</p>
                      <Progress value={browser.percentage} className="h-1 mt-2" />
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { duration: "0-30 seconds", percentage: 15.2, color: "bg-red-500" },
                      { duration: "30s - 2 minutes", percentage: 23.8, color: "bg-orange-500" },
                      { duration: "2-5 minutes", percentage: 28.4, color: "bg-yellow-500" },
                      { duration: "5-10 minutes", percentage: 18.7, color: "bg-green-500" },
                      { duration: "10+ minutes", percentage: 13.9, color: "bg-blue-500" },
                    ].map((session, index) => (
                      <div key={index} className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium">{session.duration}</span>
                          <span className="text-sm font-bold">{session.percentage}%</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Progress value={session.percentage} className="flex-1 h-2" />
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { metric: "Average View Duration", value: "6:42", change: "+12%" },
                      { metric: "Bounce Rate", value: "23.4%", change: "-5%" },
                      { metric: "Return Viewers", value: "67.8%", change: "+8%" },
                      { metric: "Subscription Rate", value: "3.2%", change: "+15%" },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div key={index} className="p-4 border rounded-lg">
                        ...
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div className="text-center">
                            <div className="text-green-600 font-bold">+{month.new.toLocaleString()}</div>
                            <div className="text-gray-500">New</div>
                          </div>
                          <div className="text-center">
                            <div className="text-red-600 font-bold">-{month.lost.toLocaleString()}</div>
                            <div className="text-gray-500">Lost</div>
                          </div>
                          <div className="text-center">
                            <div className="text-blue-600 font-bold">+{month.net.toLocaleString()}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {[
                      { source: "YouTube Search", subscribers: 12847, percentage: 42.3 },
                      { source: "Suggested Videos", subscribers: 8934, percentage: 29.4 },
                      { source: "Browse Features", subscribers: 4521, percentage: 14.9 },
                      { source: "External", subscribers: 2156, percentage: 7.1 },
                      { source: "Direct/Unknown", subscribers: 1876, percentage: 6.2 },
                    ].map((source, index) => (
                      <div key={index} className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm font-medium">{source.source}</span>
                          <div className="text-right">
                            <span className="text-sm font-bold">{source.subscribers.toLocaleString()}</span>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg">
                    <div className="text-3xl font-bold text-blue-600 mb-2">52.4K</div>
                    <div className="text-sm text-gray-600 mb-1">Projected Subscribers</div>
                  ...
                  <div className="text-center p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-lg">
                    ...
                    <div className="text-sm text-gray-600 mb-1">Projected Views</div>
                    <div className="text-xs text-green-600">Next Month</div>
                  </div>
