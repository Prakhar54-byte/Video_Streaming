...
import { ArrowLeft, Upload, Play, Pause, RotateCcw, Scissors, Download, Volume2, VolumeX } from "lucide-react"
              ...
              <CardContent>
                {!videoFile ? (
                  <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium mb-2">Upload a video to start editing</h3>
                    <Input 
                      type="file" 
                      accept="video/*" 
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                <Button variant="outline" className="w-full" disabled={!ffmpegLoaded}>
